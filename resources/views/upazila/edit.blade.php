        ...
        <div class="container">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="col-md-12">
                        {!! Form::open(['id'=>'form','url'=> 'upazila/' . $upazilaById->id . '/update']) !!}
                        <div class="col-md-6 col-md-offset-3">
                            ...
                            <div class="form-group {{$errors->has('upazila_name')?'has-error':''}}">
                                ...
                                <input type="text" name="upazila_name" class="form-control" value="{{$upazilaById->upazila_name}}">
                        ...
                        <div class="box-footer">
                            <div class="col-md-12">
                                ...
                                <button type="submit" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>Update Upazila
                                </button>
                            </div>
                        </div>
...
@section('js')
    $('select[name=district_id]').selectpicker('val', '{{old('district_id')?old('district_id'):$upazilaById->district_id}}');
@endsection